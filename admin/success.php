    ...
    <div class="flex flex-wrap mx-4">
        <div class="w-full md:w-1/2 lg:w-1/2 xl:w-1/2 px-4 mb-8">
            <section class="border-t-4 border-r-4">
                ...
                <a href="affichereclamation.php" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded block mx-auto">Gérer</a>
            </section>
        </div>
		...
		<div class="w-full md:w-1/2 lg:w-1/2 xl:w-1/2 px-4 mb-8">
            <section class="border-t-4 border-r-4">
                ...
                <a href="affichereclamtion.php" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded block mx-auto">Gérer</a>
            </section>
        </div>
