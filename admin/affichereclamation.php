...
<head>
    ...
    <style>
        ...
        .search-input {
            ...
            border: 2px solid  #38A169; /* Match border with the theme */
        ...
        .search-button {
            background-color:  #38A169; /* Purple background */
        ...
        .label-purple {
            color: #38A169 ;/* Change text color to purple */
...
<body class="p-4">
    <h2 class="text-3xl font-bold mb-4 text-green-500 text-center">Réclamations</h2>
...
<div class="text-center my-8"> <!-- Changed 'mt-8' to 'my-8' for equal spacing -->
    <button onclick="generatePDF()" class="bg-green-500 text-white font-bold py-2 px-4 rounded hover:bg-purple-800">
