...
<nav class="bg-purple-400 p-3">
    <div class="container mx-auto flex items-center justify-between">
        ...
        <div class="flex-grow text-center">
            <a class="text-white ml-4" href="../user/index.php">Accueil</a>
            <a class="text-white ml-4" href="/ssmartcity/admin/terrainsDisponible.php">Terrain</a>
            <a class="text-white ml-4" href="../admin/signalement.php">Reclamation</a>
            <a class="text-white ml-4" href="../user/suiviDechets.php">Suivi des déchets</a>
