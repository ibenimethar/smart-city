...
<div class="container mx-auto flex mt-8">
    ...
    <div class="w-1/2">
    <img src="https://trvlr.fr/wp-content/uploads/2010/03/citadelle_essaouira-scaled.jpg" alt="Description of the image" class="rounded-lg shadow-lg ">
...
<div class="container mx-auto mt-8">
    ...
    <div class="flex mb-8">
        <div class="w-1/3 pr-4">
            <img src="https://img.freepik.com/photos-gratuite/vue-du-terrain-football-herbe_23-2150887305.jpg" alt="Image Service 1" class="rounded-lg shadow-lg mb-4 ">
        </div>
        <div class="w-2/3">
            ...
            <button class="bg-blue-500 text-white px-4 py-2 rounded-full mt-2" onclick="window.location.href='/ssmartcity/user/terrainsDisponible.php'">Réserver</button>
        </div>
    </div>
    ...
    <div class="flex mb-8">
        ...
        <div class="w-2/3">
            ...
            <button class="bg-blue-500 text-white px-4 py-2 rounded-full mt-2" onclick="window.location.href='/ssmartcity/user/signalement.php'">Signaler</button>
        </div>
    </div>
    ...
    <div class="flex mb-8">
        ...
        <div class="w-2/3">
            ...
            <button class="bg-blue-500 text-white px-4 py-2 rounded-full mt-2" onclick="window.location.href='/ssmartcity/user/suiviDechets.php'">Suivre</button>
        </div>
    </div>
    ...
    <div class="flex mb-8">
        ...
        <div class="w-2/3">
            ...
            <button class="bg-blue-500 text-white px-4 py-2 rounded-full mt-2" onclick="window.location.href='/ssmartcity/user/displayPlacesTouristiques.php'">Explorer</button>
        </div>
    </div>
